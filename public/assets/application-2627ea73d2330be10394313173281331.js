...
(function() {
  $(function() {
    return $("#comment_body, #community_name").keypress(function(event) {
      if (event.which === 13) {
        event.preventDefault();
...
(function() {
  $(function() {
    $('#add_a_community_link').click(function() {
      $(this).parent().next().slideToggle();
      return false;
    });
    return $('#community_header_info_link').click(function() {
...
(function() {
  ...
  initTagInput = function() {
    ...
    return $tagInput.tokenInput("/items/tags.json", {
      theme: 'facebook',
      tokenValue: 'name',
